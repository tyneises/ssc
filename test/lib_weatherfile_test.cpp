...
protected:
	void SetUp(){
		e = 0.001;
		file = "../../../input_docs/weather-noRHum.csv";
...
TEST_F(CSVCase_WeatherfileTest, normalizeCityTest){
...
TEST_F(Data8760CaseWeatherData, initTest){
...
TEST_F(Data8760CaseWeatherData, readTest){
	weatherdata wd(input);
	weather_record r;
...
TEST_F(Data9999CaseWeatherData, initTest){
	weatherdata wd(input);
...
TEST_F(Data9999CaseWeatherData, initTest2){
...
TEST_F(Data9999CaseWeatherData, readTest2){
