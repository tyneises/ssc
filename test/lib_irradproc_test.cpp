...
TEST_F(NightCaseIrradProc, solarposTest){
...
TEST_F(SunriseCaseIrradProc, solarposTest){
	double sun[9];
	vector<double> sunrise_times;
	vector<double> sunset_times;
...
TEST_F(DayCaseIrradProc, solarposTest){
	double sun[9];
	vector<double> sunrise_times;
	vector<double> sunset_times;
...
TEST_F(SunsetCaseIrradProc, solarposTest){
	double sun[9];
	vector<double> sunrise_times;
	vector<double> sunset_times;
...
TEST_F(NightCaseIrradProc, incidenceTest){
	int mode = 0;
	double angle[5] = { 0 };
...
TEST_F(SunriseCaseIrradProc, incidenceTest){
	int mode = 0;
	double angle[5] = { 0 };
	double sun_zen, sun_azm;
	double solution;
...
TEST_F(DayCaseIrradProc, incidenceTest){
	int mode = 0;
	double angle[5] = { 0 };
	double sun_zen, sun_azm;
	double solution;
...
TEST_F(SunsetCaseIrradProc, incidenceTest){
	int mode = 0;
	double angle[5] = { 0 };
	double sun_zen, sun_azm;
	double solution;
...
TEST_F(NightCaseIrradProc, CalcTestRadMode0){
	vector<double> sun_p;
	sun_p.resize(10);
	int sunup = false;
...
TEST_F(SunriseCaseIrradProc, CalcTestRadMode0){
	vector<double> sun_p;
	sun_p.resize(10);
	int sunup = true;
	vector<double> angle_p;
...
TEST_F(DayCaseIrradProc, CalcTestRadMode0){
	vector<double> sun_p;
	sun_p.resize(10);
	int sunup = true;
	vector<double> angle_p;
...
TEST_F(SunsetCaseIrradProc, CalcTestRadMode0){
	vector<double> sun_p;
	sun_p.resize(10);
	int sunup = false;
	vector<double> angle_p;
