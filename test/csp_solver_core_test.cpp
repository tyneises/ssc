...
#include <..\input_sources\weather_inputs.h>
...
TEST_F(UsingFileCaseWeatherReader, IntegrationTest){
	wr.init();
	//check header values
...
TEST_F(UsingDataCaseWeatherReader, IntegrationTest){
	wr.init();
	//check header values
